...
//AuctionCreator allows many auctions to take place with 
contract AuctionCreator{
    Auction[] public auctions;

    function createAuction() public{
        Auction newAuction = new Auction(msg.sender); //now anyone can auction and be the OWNER of their auction instead of a contract owning the auction
